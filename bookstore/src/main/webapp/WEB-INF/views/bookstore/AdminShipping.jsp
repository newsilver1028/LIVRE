...
<h3 style="color: #3C342E !important; margin-top:30px; margin-bottom:30px; font-family: 'Nanum Gothic', sans-serif;"><b>SHIPPING STATUS</b></h3>
	...
	<c:forEach var="store" items="${list }">
		...
		<td>
			<select id="datalist" class="${store.bno }" name="dataList" form="actionForm" required>
					...
					<option value="판매 중">결제 취소</option>
				</select>
...
<input type="button" id="refund" class="btn btn-lg btn-primary btn-block" name="${store.bno }" style="margin-right:20px;width:70px !important; border: none; font-size:0.9em;" value="확인">
 <hr style="border-top: 1px dashed #3C342E; width:90%; border-bottom:none; margin-top:80px;margin-bottom:100px;" >
	...
	<script>
		$("#divdiv #refund").mouseover(function() {
			$(this).css("background-color", "#746B65");
		})
		$("#divdiv #refund").mouseleave(function() {
