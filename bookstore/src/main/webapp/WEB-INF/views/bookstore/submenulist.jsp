...
<link rel="stylesheet"
   ...
   crossorigin="anonymous">
      ...
      <form id="searchForm" action="/bookstore/submenulist" method="get" >
            &nbsp;&nbsp;&nbsp;<select name="type" style="border-radius:4px;margin-top:-88px; margin-right:420px; float:right; height:35px; border:1px solid #CBCBCB;  outline:none;">
               ...
               <option value="P" ${pageMaker.cri.type eq "W"?"selected":"" }>
                  출판사</option></select><input type="text" class="form-control" name="keyword"
               value="${pageMaker.cri.keyword }" style="margin-top:-90px; width:270px; margin-right:140px; float:right;" /><input type="hidden"
               name="pageNum" value="${pageMaker.cri.pageNum }"> 
               <input type="hidden" name="amount" value="${pageMaker.cri.amount }">
               <button class="btn btn-warning" id="searchbt" style="border:none; outline:none; color:white; margin-top:-90px; margin-right:60px; float:right;">Search</button>
               <input type="hidden" name="hiddenmenu" value="${genre}">
         </form>
...
<div align="center"
   ...
   <form id="actionForm" action="/bookstore/submenulist" method="get">
...
<div style="float:right !important; margin-right:700px;" >
   <ul class="pagination justify-content-center">
      <c:if test="${pageMaker.prev}">
         ...
         <a href="${pageMaker.startPage-1 }" class="page-link">Prev</a></li>
      </c:if>
...
<form id="actionForm2" action="/bookstore/submenulist" method="get">
...
$("#searchbt").mouseover(function(){$(this).css("background-color","#746B65");})
$("#searchbt").mouseleave(function(){$(this).css("background-color", "#3C342E");})
   $(document)
         .ready(
               function(e) {
